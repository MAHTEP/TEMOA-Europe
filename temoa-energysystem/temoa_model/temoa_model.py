...
def temoa_create_model(name="Temoa"):
  ...
  """
    ...
    M.ExistingCapacity = Param(M.RegionalIndices, M.tech_all, M.vintage_all)

    M.CapacityReduction_rtv = Set(dimen=3, initialize=CapacityReductionIndices)
    M.CapacityReduction = Param(M.CapacityReduction_rtv, default=1)
    ...
    M.MinInputGroupWeight = Param(M.regions, M.tech_groups, M.groups, default=0)
    M.MinInputGroup = Param(M.regions, M.time_optimize, M.commodity_physical, M.groups)
    M.MaxInputGroupWeight = Param(M.regions, M.tech_groups, M.groups, default=0)
    M.MaxInputGroup = Param(M.regions, M.time_optimize, M.commodity_physical, M.groups)
    M.MaxOutputGroupWeight = Param(M.regions, M.tech_groups, M.groups, default=0)
    ...
    M.MaxGenGroupWeight = Param(M.RegionalIndices, M.tech_groups, M.groups, default=0)
