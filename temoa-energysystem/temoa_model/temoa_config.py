...
def db_2_dat(ifile, ofile, options):
	...
	table_list = [
		...
		['param','MaxGenGroupLimit',          '',                    '',             2],
		['param','MaxGenGroupWeight',         '',                    '',             3],
		['param','LinkedTechs',               '',                    '',             3],
		['param','SegFrac',                   '',                    '',             2],
		...
		['param','MinInputGroupWeight',       '',                    '',             3],
		['param','MinInputGroup',             '',                    '',             4],
		['param','MaxInputGroupWeight',       '',                    '',             3],
		['param','MaxInputGroup',             '',                    '',             4],
		['param','MaxOutputGroupWeight',      '',                    '',             3],
